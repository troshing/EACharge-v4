...
namespace NModbus.Message
{
    internal class ReadFileRecordRequest : AbstractModbusMessageWithData<FileRecordCollection>, IModbusRequest
    {
        ...
        public ReadFileRecordRequest(byte slaveAdress, FileRecordCollection data)
    : base(slaveAdress, ModbusFunctionCodes.ReadFileRecord)
        {
            Data = data;
        ...
        {
            var typedResponse = (ReadFileRecordResponse)response;
